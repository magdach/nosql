...
200.times do |i|
	xml = Net::HTTP.get_response(URI.parse('http://isbndb.com/api/books.xml?access_key=4K8HD2R9&page_number=' + i.to_s  + '&index1=full&value1=elephant'))
	...
	doc.elements.each('ISBNdb/BookList/BookData') do |elem|
		...
		book['isbn13'] = elem.attributes['isbn13'].to_s
